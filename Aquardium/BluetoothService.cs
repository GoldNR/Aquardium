...
namespace Aquardium
{
    public class BluetoothService
    {
        ...
        {
            var service = await device.GetServiceAsync(Guid.Parse("00001809-0000-1000-8000-00805f9b34fb"));  // Replace with Arduino Service UUID
            var tempCharacteristic = await service.GetCharacteristicAsync(Guid.Parse("00002A6E-0000-1000-8000-00805f9b34fb"));  // Replace with Arduino Characteristic UUID
